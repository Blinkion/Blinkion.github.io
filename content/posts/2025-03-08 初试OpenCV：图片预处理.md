...
市面上各种文档扫描软件早已屡见不鲜，背后的逻辑往往很复杂，但使用流行的Python第三方库OpenCV是否能解决此问题呢？下面的demo 是我的一些小小尝试。

# 流程

因为不想在本地环境配置上浪费掉过多时间，故我直接选择了[colab](https://colab.research.google.com/),想要本地配置的请自己准备好以下依赖（其它未测试版本不担保可用性）
...
{{< code language="python" title="核心处理流程" id="5" expand="Show" collapse="Hide" isCollapsed="true" >}}
...
这里给出一个样本成果
{{< image src="https://github.com/Blinkion/blog_pics/blob/28138e028c35a217009aa3946acec18d87e8a9df/2025-03-08-01.png" alt="one example" position="center" style="border-radius: 8px;" >}}
